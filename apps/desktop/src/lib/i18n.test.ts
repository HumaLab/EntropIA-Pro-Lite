...
describe('i18n', () => {
  ...
  it('translates extracted-text actions, states, and export formats in Spanish and English', async () => {
    ...
    expect(t('item.exportExtractedTextMarkdown')).toBe('Documento Markdown (.md)')
    expect(t('item.exportExtractedTextPdf')).toBe('Documento PDF (.pdf)')
    expect(t('item.exportExtractedTextDocx')).toBe('Microsoft Word (.docx)')
    ...
    expect(t('item.exportExtractedTextMarkdown')).toBe('Markdown document (.md)')
    expect(t('item.exportExtractedTextPdf')).toBe('PDF document (.pdf)')
    expect(t('item.exportExtractedTextDocx')).toBe('Microsoft Word (.docx)')

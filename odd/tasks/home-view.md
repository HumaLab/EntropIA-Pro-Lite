...
- All tasks done (T1–T6c). Waiting for the user's visual check. next T5 (Nueva investigación, Nuevo documento, Crear colección, Ver guía), then T6 (constellation, needs a decision).
